...
class Workout(object):
    ...
    def get_calories(self):
        ...
        ---
        #### return: 
            int, the total calories burned in the workout.
        '''
    ...
    def get_duration(self):
        ...
        ---
        #### return:
            datetime.interval object, the duration of the workout.
        '''
    ...
    def get_start(self):
        ...
        ---
        #### return:
            datetime.datetime object, the start time of the workout.
        '''
        return self.start
    ...
    def get_type(self):
        ...
        ---
        #### return: 
            string, the type of the workout.
        '''
        return self.type
    ...
    def __eq__(self, other):
        ...
        ---
        #### return: 
            bool, true if this workout is equal to another workout, false o.w.
        '''
    ...
    def __str__(self):
        ...
        ---
        #### return:
            a text-based graphical depiction of the workout. 
        '''
        width = 16
        retstr =  f"|{'–'*width}|\n"
        retstr += f"|{' ' *width}|\n"
...
class SwimWorkout(Workout):
    ...
    def get_calories(self):
        ...
        ---
        #### return: 
            the total calories burned in the swim workout
    ...
    def count_lap(self):
        '''
        Updates numlaps by +1 if called. 
        '''
        self.numlaps += 1
    ...
    def get_average_laptime(self):
        ...
        ---
        #### return:
            int, average laptime for a workout.
        '''
        if not self.numlaps:
            return None
    ...
    def __str__(self):
        '''
        Overwrites the __str__ dunder method to display Num Laps.
        '''
    ...
    def end_swim_workout(self):
        '''
        #### print:
            string, Workout Complete and the Workout summary given by 
            the updated __str__ dunder method.
        '''
...
wo_new = SwimWorkout('9/30/2021 2:20 PM', '9/30/2021 2:50 PM')

# 2) Swim 40 laps
# Loop: iterate over eahc number in range 0 to 39
for n in range(40):
    wo_new.count_lap()

# 3) Print average laptime
print(wo_new.get_average_laptime())

# 4) Display workout summary
wo_new.end_swim_workout()